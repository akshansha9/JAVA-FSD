...
<head>
    ...
    <style>
        body {
            ...
            animation-timing-function: animation-timing-function: steps(5, end);;
        ...
        @keyframes backgroundSlideshow {
            ...
            66% {
                background-image: url("train3.png");
            }
            100% {
                background-image: url("train.jpg");
            }
...
<body>
<nav class="navbar navbar-expand-lg bg-body-tertiary navbar-dark border-bottom border-bottom-dark"
     data-bs-theme="dark">
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ml-auto">
                <!-- Move the "Home", "Admin-Login/Signup", "User-Login/Signup" links to the right using custom CSS -->
