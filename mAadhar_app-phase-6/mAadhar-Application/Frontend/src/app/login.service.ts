...
export class LoginService {
  baseURL:string = "http://localhost:7090/login";
  operationURL:String = "http://localhost:7090/operation";
  constructor(public http:HttpClient) { }

  note1():Observable<any>{
    return this.http.get("http://localhost:7090/login/note",{responseType:"text"} );
  }
